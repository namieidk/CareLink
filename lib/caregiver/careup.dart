...
class CareSignUpScreen extends StatefulWidget {
  ...
  @override
  State<CareSignUpScreen> createState() => _CareSignUpScreenState();
}

class _CareSignUpScreenState extends State<CareSignUpScreen>
                                ...
                                WidgetSpan(
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      Navigator.of(context).pushReplacement(
                                        MaterialPageRoute(
                                          builder: (context) => const CareSignInScreen(),
                                        ),
                                      );
                                    },
                                    child: const Text(
