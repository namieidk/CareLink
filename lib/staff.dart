...
import 'doctor/docsign.dart';   
import 'caregiver/caresign.dart';        
...
// -----------------------------------------------------------------
// WELCOME SCREEN 2 – DOCTOR / CAREGIVER SELECTION
// -----------------------------------------------------------------
...
class _WelcomeScreen2State extends State<WelcomeScreen2>
  ...
  String _selectedRole = ''; // '' = none, 'doctor' or 'caregiver'
      ...
      Navigator.of(context).push(
        PageRouteBuilder(
          ...
          pageBuilder: (_, __, ___) {
            // Doctor → docsign.dart
            if (role == 'doctor') {
              return const DocSignInScreen();
            }
            // Caregiver → caresign.dart
            return const CareSignInScreen();
          },
  ...
  Widget build(BuildContext context) {
    ...
    // Back icon positioning (safe area aware)
    final double backIconTop = MediaQuery.of(context).padding.top + 16;
    final double backIconLeft = isWeb ? size.width * 0.04 : 20;
