...
class _DocSignUpScreenState extends State<DocSignUpScreen>
  ...
  // Updated fields
  final _doctorIdController = TextEditingController(text: 'DR12345');
  final _usernameController = TextEditingController(text: 'dr_john');
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ...
                                    Navigator.of(context).pushReplacement(
                                      MaterialPageRoute(
                                        builder: (context) => const DocSignInScreen(),
                                      ),
                                    );
                                  },
                                  child: const Text(
  ...
  // ──────────────────────────────────────────────────────────────
  // TextField builder (now accepts hintText)
  // ──────────────────────────────────────────────────────────────
